...
<div class="row">
    ...
    <div class="col-md-2 col-12 text-end">
        <button class="btn btn-primary waves-effect waves-light" data-bs-toggle="modal" data-bs-target="#modal-master-universitas">Tambah Universitas</button>
    </div>
</div>
<div class="col-xl-12">
...
<div class="modal fade" id="modal-master-universitas" tabindex="-1" aria-hidden="true">
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <form class="default-form" method="POST" enctype="multipart/form-data" action="{{ route('super.univ.store') }}">
                @csrf
...
<script>
    ...
    function edit(e) {
        ...
        let action = `{{ url('universitas/update') }}/${id}`;
        var url = `{{ url('universitas/edit') }}/${id}`;
